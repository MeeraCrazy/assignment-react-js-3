...
class App extends Component {
  ...
  imageClick = thumbnailUrl => {
    ...
    const imageValue = imagesList.filter(
      eachVlaue => eachVlaue.thumbnailUrl === thumbnailUrl,
    )
  ...
  render() {
    const {score, time, imgUrl, category, isTrue} = this.state
          ...
          {!isTrue && (
            <div className="first-div">
              ...
              <ul className="thumbnail-images">
                {thumbnailList.map(eachVlaue => (
                  <li key={eachVlaue.id}>
                    <button
                      type="button"
                      className="image-button"
                      onClick={() => this.imageClick(eachVlaue.thumbnailUrl)}
                    >
                      <img
                        src={eachVlaue.thumbnailUrl}
                        alt="thumbnail"
